...
angular.module('agiloBoardsApp').constant("AGILO_REPORT_STORIES_BY_RELEASE", {id: 0, type: 1, title: 2, release: 3, state: 4, owner: 5, keywords: 6, storyPoints: 7, timeDone: 8, timeRemaining: 9, sprint: 10, project: 11, parentId: 12});
